...
namespace _01_Listas
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //valor padrão num array quando não inicializava = 0
            Console.WriteLine($"Valor da variavel idades na posicao 5: {idades[5]}\n");

            //Lenght = número de elementos que esse array possui.
            Console.WriteLine("O array idades tem " + idades.Length + " posições.\n");

            //acumulador irá guardar a soma dos números dentro do laço for
            int acumulador = 0;

            //i = indice começa com 0/ enquanto for menor que o tamanho de idades[] /aumenta um indice
            for(int i = 0; i <idades.Length; i++)
            {
                int idade = idades[i];
                Console.WriteLine($"Acessando o array idades no indice {i}"); //pegando posição 0
                Console.WriteLine($"Valor de idades[{i}] = { idade}\n"); //exibindo o conteudo do array
                acumulador += idade;
            }

            int media2 = acumulador / idades.Length;
            Console.WriteLine($"Médias de idades = {media}");
            /*==========================================================*/
            Console.WriteLine();
